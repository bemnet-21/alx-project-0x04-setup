  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-yellow-400 to-pink-500 flex flex-col justify-center items-center text-white'>
        ...
        <div className='flex space-x-4'>
          <button onClick={increment}className='bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-8 rounded-full text-lg transition duration-300 shadow-lg transform hover:scale-105'>Increment 🚀</button>
